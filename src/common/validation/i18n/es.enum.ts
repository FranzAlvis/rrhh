export enum ValidationMessageEnum {
  ...
  MAX_DATE = 'fecha máxima permiida para ',
  ...
  IS_ASCII = '$property debe contener sólo caracteres ASCII.',
  ...
  IS_VARIABLE_WIDTH = 'property debe contener un ancho completo y caracteres de ancho medio.',
  ...
  IS_LATITUDE = '$property debe ser una cadena o número de latitud.',
  IS_LONGITUDE = '$property debe ser una cadena o número de longitud.',
  IS_URL = '$property debe ser una dirección URL válida.',
  IS_UUID = '$property debe ser un UUID.',
  LENGTH = '$property debe ser mayor o igual a $constraint1 y menor o igual a $constraint2 caracteres',
  ...
  ARRAY_NOT_EMPTY = '$property no debe estar vacío.',
  ARRAY_MIN_SIZE = '$property debe contener al menos $constraint1 elementos.',
  ARRAY_MAX_SIZE = '$property no debe contener mas de $constraint1 elementos.',
  ...
  NRO_LIBRETA_SERVICIO_MILITAR = '$property debe ser un número de formato 00-000000-0',
  NOMBRE_USUARIO = '$property contiene careteres de más o no válidos.',
  NRO_FUNCIONARIO_CARRERA = '$property debe ser un número de funcionario carrera válido.',
  NRO_REGISTRO_PROFECIONAL = '$property debe ser un número de registro profesional válido.',
}
