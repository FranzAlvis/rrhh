...
import { NroLibretaServicoMilitar as _NroLibretaServicoMilitar } from './nro-libreta-servicio-militar.validator'
import { NombreUsuario as _NombreUsuario } from './nombre-usuario'
import { NroFuncionarioCarrera as _NroFuncionarioCarrera } from './nro-funcionario-carrera'
import { NroRegistroProfesional as _NroRegistroProfesional } from './nro-registro-profecional'
...
export const NroLibretaServicoMilitar = _NroLibretaServicoMilitar
export const NombreUsuario = _NombreUsuario
export const NroFuncionarioCarrera = _NroFuncionarioCarrera
export const NroRegistroProfesional = _NroRegistroProfesional
